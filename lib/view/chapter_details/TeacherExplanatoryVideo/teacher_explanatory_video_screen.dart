...
class TeacherExplanatoryVideoScreen extends StatefulWidget {
  const TeacherExplanatoryVideoScreen({super.key});

  @override
  State<TeacherExplanatoryVideoScreen> createState() =>
      _TeacherExplanatoryVideoScreenState();
}

class _TeacherExplanatoryVideoScreenState
    extends State<TeacherExplanatoryVideoScreen> {
