...
class KeywordListItemWidget extends StatefulWidget {
  const KeywordListItemWidget({super.key});

  @override
  State<KeywordListItemWidget> createState() => _KeywordListItemWidgetState();
}

class _KeywordListItemWidgetState extends State<KeywordListItemWidget> {
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    ...
                                    style:
                                        AppTextStyle.readexTextStyle14Regular()
                                            .copyWith(
                                      fontSize: 14,
                                      color: AppColors.blueGray600,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  TextSpan(
                                    ...
                                    style:
                                        AppTextStyle.readexTextStyle12Regular()
                                            .copyWith(
                                      fontSize: 14.sp,
